...
--
-- Host: localhost
-- Generation Time: Nov 18, 2023 at 03:25 PM
...
(763706807, 'Financial Success Blueprint', '655878373a693.jpg', 'Strategies for achieving financial success and independence.', 'cd', 'Emma', 'Turner', 'Tech Publications', '123 Wealth Street, Prosperity City', '2023-08-05'),
...
--
ALTER TABLE `library`
  MODIFY `ISBN` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9178718002;
COMMIT;
